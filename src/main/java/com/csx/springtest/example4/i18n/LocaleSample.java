...
public class LocaleSample {
    ...
    public void resourceBoundle(){
        ResourceBundle rb1 = ResourceBundle.getBundle("com.csx.springtest.example4.i18n/resource",Locale.US);
        ResourceBundle rb2 = ResourceBundle.getBundle("com.csx.springtest.example4.i18n/resource",Locale.CANADA);
    ...
    public void resourceBoundleFmt(){
        ResourceBundle rb1 = ResourceBundle.getBundle("com.csx.springtest.example4.i18n/fmt_resource",Locale.US);
        ResourceBundle rb2 = ResourceBundle.getBundle("com.csx.springtest.example4.i18n/fmt_resource",Locale.CHINA);
