...
//      scoreService.addScore(userName, 20);
    ...
    /**
     * 相互嵌套的调用的方法工作不同的线程中，则不同线程下的事物方法工作在独立的事物中
     * @param args
     */
    public static void main(String[] args) {
        ApplicationContext ctx = new ClassPathXmlApplicationContext("com/csx/springtest/example8/multithread/applicatonContext.xml");
