package com.csx.springtest.example8.withouttx.hiber;
...
public class UserHibernateWithoutTransManagerService {
    ...
    public void addScore(String userName,int toAdd){
        ...
        /*
         * 如果hibernate不配置事物spring将会默认采用(PROPAGATION_REQUIRED,readOnly)事物管理策略，有修改操作将会抛异常
         */
    ...
    public static void main(String[] args) {
        ApplicationContext ctx = new ClassPathXmlApplicationContext("com/csx/springtest/example8/withouttx/hiber/hiberWithoutTx.xml");
