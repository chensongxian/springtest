package com.csx.springtest.example8.withouttx.jdbc;
...
public class UserJdbcWithoutTransManagerService {
    ...
    public static void main(String[] args) {
        ApplicationContext ctx = new ClassPathXmlApplicationContext("com/csx/springtest/example8/withouttx/jdbc/jdbcWithoutTx.xml");
