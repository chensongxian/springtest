package com.csx.springtest.example8.nestcall;
...
public class UserService extends BaseService{
    ...
    /**
     * 相同线程的相互嵌套的事物方法调用工作在相同的事物中
     * @param args
     */
    public static void main(String[] args) {
        ApplicationContext ctx = new ClassPathXmlApplicationContext("com/csx/springtest/example8/nestcall/applicatonContext.xml");
